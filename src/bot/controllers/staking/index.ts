import { reduceAmount } from "@/bot/utils";
    ...
    ctx.reply(msg,
        {
            ...
            reply_markup: {
                ...
                keyboard: [
                    [{ text: 'Refresh ❄' }, Markup.button.webApp(chainId === 137 ? 'Switch to Arbitrum 💫' : 'Switch to Polygon 💫', `${process.env.MINIAPP_URL}?chainId=${chainId}&forChainSelection=true`)],                        
